...
from .vggface2_resnet import resnet50, load_state_dict


# Seems to be from https://www.robots.ox.ac.uk/~albanie/models/pytorch-mcn/resnet50_scratch_dag.py
# But the link to pretrained .pth (http://www.robots.ox.ac.uk/~albanie/models/pytorch-mcn/resnet50_scratch_dag.pth)
# is dead. See https://github.com/ox-vgg/vgg_face2/issues/52
